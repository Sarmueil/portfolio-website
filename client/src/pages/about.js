              ...
              <div className="about_text">
                  <p className="about_texta">Hello. I'm Samuel Adedoyin Adebisi and I'm a multi-talented
                   ...
                   <p className="textb">I write javascript mainly on both the client-side and server side. I work with React.js and Next.js on the front-end as well as Node.js on the back-end. I find myself working most of the time with frontend technologies
                    ...
                    <p className="textb">
                    My journey as a developer started already in 2019, I started working as a front-end developer for a start-up named Parakletus Hub, I contributed to delevoping a product called para-learn
                    which helps student share and and learn course across specific nigerian univeristies. I got an associate software engineeer position at Decagon, where i worked for 6months on contract. 
