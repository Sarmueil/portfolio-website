  ...
  return (
    <div className='page'>
      <div className='container'>  
       <div className='row'>
           <div style={{backgroundColor:'black',width:'100%', borderRadius:'20px', paddingBottom:'1.8rem'}}>
           <div>
        <div style={{marginTop:'1rem', marginBottom:'.5rem', width:'100%', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          <h2 style={{color:'white', fontSize:'2.5rem', marginLeft:'2rem', cursor:'pointer'}}>Projects</h2>
       </div>
